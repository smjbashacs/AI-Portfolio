...
<div style="background-color: #f0f0f0; padding: 20px; margin-bottom: 40px; border-radius: 5px; border: 3px solid #159957;"> 
  <h1 style="text-align: center; color: black; text-decoration: none !important;" id="nlp-projects">Machine Learning Projects</h1>
