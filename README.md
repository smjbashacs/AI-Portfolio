...
<div style="width: 900; padding: 10px 20px; display: block; background-color: #F6F5F5; border-radius: 5px; margin-bottom: 20px; border: 1px solid black; box-shadow: 0 0 8px 0px #C1C1C1"> 
    ...
    <div style="color: black;  font-family: sans-serif; font-size: 18px; line-height: 1.8; margin-top: 5px">
