...
<div style="display: flex; justify-content: center; width: 100%; padding: 0 20px; gap: 10px; margin-bottom: 18px; background-color: #98FB98; border-bottom: 1px solid #ccc; border-radius: 8px">
