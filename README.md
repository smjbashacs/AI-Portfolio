...
<h1 style="text-align: center; color:#764cc1; border-bottom: 4px solid #e1e4e8 margin-top: 20px" id="ml-projects">Machine Learning Projects</h1>
...
<h1 style="text-align: center; color:#764cc1; border-bottom: 4px solid #e1e4e8 margin-top: 20px" id="dl-projects">Deep Learning Projects</h1>
